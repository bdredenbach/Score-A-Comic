...
The player crossfades between cues and loops the current one by default. Switch to
**ADVANCE** to automatically move to the next cue when the current one ends.
